...
function updateTable() {
    var suitableRows = getSuitableRows(columnSelector.value, filterableText.value);
    
    // If string is empty, show all rows
    ...
    function getSuitableRows(columnName, filterableText) {
        ...
        if (columnName === '#' && isNumeric(filterableText) && +filterableText > 0 && +filterableText <= tableData.length + 1) {
